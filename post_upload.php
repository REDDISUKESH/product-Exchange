...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
   ...
   /*  $isbn = $_POST["poisbn"];
    ...
    $imgname1 = $_FILES["productpic"]["name"];
    $imgerr1 = $_FILES["productpic"]["error"];
    $imgtemp1 = $_FILES["productpic"]["tmp_name"];
    $imgtype1 = $_FILES["productpic"]["type"];
   ...
   /*  $imgname3 = $_FILES["bookpic3"]["name"];
    ...
    if(in_array($imgactualext1,$allowed))
    {
        ...
        if($imgerr1===0)
        {
            ...
            $filedestination1=':\xampp\htdocs\miniproject\imageupload\post_upload.php'.$img_new1;
        }
        else
        {
            $err1=true;
        ...
        */ /* if($err3==true)
        ...
        {*/
           ...
           /*  move_uploaded_file($imgtemp2,$filedestination2);
            ...
            $sql="INSERT INTO `product` (`p_name`, `og_pr`, `ex_pr`, `descript`, `pic1`,'gene1`,usenam`) VALUES('$productname','$ogpirce', '$exprice', '$description', '$filedestination1','$gener1',$username')";
